    ...
    <div className="container mx-auto px-4 py-8">
          ...
          <tbody>
            {data.map((item) => (
              <tr key={item.id} className="border-b last:border-none">
                ...
                <td className="py-4 px-6 text-gray-600">{item.link}</td>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center z-50">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg z-10 w-96">
            <h2 className="text-xl font-semibold mb-4">Edit Edition</h2>
            <form
              onSubmit={(e) => {
                e.preventDefault();
                handleUpdate({
            ...
            >
              ...
              <div className="mb-4">
                ...
                <input
                  type="text"
                  name="link"
                  defaultValue={selectedMember?.link}
                  className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                />
              </div>
      ...
      {isAddModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center z-50">
          <div className="bg-black opacity-50 fixed inset-0"></div>
          <div className="bg-white p-6 rounded-lg shadow-lg z-10 w-96">
            <h2 className="text-xl font-semibold mb-4">Add New Edition</h2>
            <form
              onSubmit={(e) => {
                e.preventDefault();
                handleAddMember();
            ...
            >
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewMember({ ...newMember, link: e.target.value })
                  }
                  className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                />
              </div>
